...
CKEDITOR.dialog.add("anchor", function (c) {
    ...
    return {
        ...
        getModel: function (b) {
            ...
            b = a && a.type === CKEDITOR.NODE_ELEMENT && ("anchor" === a.data("cke-real-element-type") || a.is("a")) ? a : void 0;
            return b || null;
        },
        onOk: function () {
            var b = CKEDITOR.tools.trim(this.getValueOf("info", "txtName")),
                ...
                a = this.getModel(c);
            if (a) a.data("cke-realelement") ? ((b = f(c, b)), b.replace(a), CKEDITOR.env.ie && c.getSelection().selectElement(b)) : a.setAttributes(b);
                ...
                for (var e = new CKEDITOR.dom.walker(d), d = d.collapsed ? d.startContainer : e.next(), g = a.createBookmark(); d; )
                    d.type === CKEDITOR.NODE_ELEMENT && d.getAttribute("data-cke-saved-name") && (d.remove(!0), e.reset()), (d = e.next());
                a.moveToBookmark(g);
                ...
                elements: [
                    {
                        ...
                        validate: function () {
                            var b = this.getValue();
                            return b ? (/[\u0020\u0009\u000a\u000c\u000d]/g.test(b) ? (alert(c.lang.link.anchor.errorWhitespace), !1) : !0) : (alert(c.lang.link.anchor.errorName), !1);
                        },
                    },
                ],
            },
